...
from tacotron2.text.symbols import eng_symbols, kor_symbols
...
if __name__ == "__main__":
  ...
  print(_clean_text("'아줌마'는 결혼한 여자를 뜻한다.", ['english_cleaners']))
  print(text_to_sequence("아줌마는 결혼한 여자를 뜻한다.", ['korean_cleaners']))
'''
